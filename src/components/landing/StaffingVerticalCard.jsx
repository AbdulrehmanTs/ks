...
const StaffingVerticalCard = ({ card, openModal, setSelectedProgram }) => {
    const [active, setActive] = useState('active')
    let { hash } = useLocation()

    const clickHandler = () => {
        openModal()
        setSelectedProgram(card.heading)
    }

    return (
        <div onClick={clickHandler} className={'new_vertical_card ' + active}>
...
export default StaffingVerticalCard
